...
namespace GitUI
{
    ...
    public sealed partial class RevisionGrid : GitModuleControl
    {
        ...
        private LogOptions _logParam = LogOptions.All | LogOptions.Boundary;
        ...
        public void ForceRefreshRevisions()
        {
            try
            {
                ...
                if (!Settings.ShowGitNotes && _logParam == (LogOptions.All | LogOptions.Boundary))
                    _logParam |= LogOptions.ShowGitNotes;
                ...
                _revisionGraphCommand = new RevisionGraph(Module) { BranchFilter = BranchFilter, LogParam = _logParam, Filter = _revisionFilter.GetFilter() + Filter + FixedFilter };
        ...
        private void SetShowBranches()
        {
            ...
            if (!Settings.BranchFilterEnabled)
                _logParam = LogOptions.All | LogOptions.Boundary;
