...
namespace GitUI
{
    ...
    public class FilterBranchHelper
    {
            ...
            : this()
        {
            ...
            this.toolStripDropDownButton2.DropDownItems.AddRange(new ToolStripItem[] {
            this.localToolStripMenuItem,
            this.remoteToolStripMenuItem});

            this.toolStripBranches.DropDown += this.toolStripBranches_DropDown;
            this.toolStripBranches.TextUpdate += this.toolStripBranches_TextUpdate;
            this.toolStripBranches.Leave += this.toolStripBranches_Leave;
            this.toolStripBranches.KeyUp += this.toolStripBranches_KeyUp;
    ...
    public class FilterRevisionsHelper 
    {
            ...
            : this()
        {
            ...
            this.toolStripLabel2.Click += this.ToolStripLabel2Click;
            this.toolStripTextBoxFilter.Leave += this.ToolStripTextBoxFilterLeave;
            this.toolStripTextBoxFilter.KeyPress += this.ToolStripTextBoxFilterKeyPress;
        }
